...
<body>
            ...
            <table>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <input type="button" onclick="phoneNumCheck()" name="phoneNum_check" value="전화번호 확인">
                        <input type="hidden" id="phoneNum_uncheck" name="phoneNum_duplication" value="phoneNum_uncheck">
                    </td>
                </tr>
                <tr>
                    <th>
    ...
    <script>
        ...
        function JoinInputCheck() {
            ...
            var checkEmail1 = document.getElementById("userEmail1").value
            var checkEmail2 = document.getElementById("userEmail2").value
            ...
            else if(checkEmail1.length == 0 || checkEmail1 == "" || checkEmail2.length == 0 || checkEmail2 == "") {
                alert("이메일을 입력해주세요")
                return false
            }
